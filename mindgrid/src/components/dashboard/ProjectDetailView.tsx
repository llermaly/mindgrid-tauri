      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--border-subtle)]">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div
              className="w-10 h-10 rounded-xl flex items-center justify-center text-lg font-medium"
              style={{ background: preset?.color || "var(--bg-tertiary)" }}
            >
              {preset?.icon || "?"}
            </div>
            <div>
              <h2 className="font-semibold text-[var(--text-primary)]">{project.name}</h2>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 bg-[var(--accent-primary)] hover:bg-[var(--accent-primary-hover)] rounded-lg text-sm font-medium text-white flex items-center gap-2 transition-colors"
          >
          ...
          <div className="space-y-4">
            {project.github ? (
              <>
                <div className="card p-5">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <svg className="w-5 h-5 text-[var(--text-tertiary)]" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <div className="text-sm font-medium text-[var(--text-primary)]">{project.github.repo}</div>
                        <div className="text-xs text-[var(--text-tertiary)]">Repository</div>
                      </div>
                    </div>
                    <div className="px-3 py-1.5 bg-[var(--bg-hover)] border border-[var(--border-subtle)] rounded-lg text-sm text-[var(--text-secondary)]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-3 bg-[var(--bg-hover)] rounded-lg">
                      <div className="text-xs text-[var(--text-tertiary)] mb-1">Default Branch</div>
                      <div className="text-sm text-[var(--text-primary)]">{project.github.defaultBranch}</div>
                    </div>
                    <div className="p-3 bg-[var(--bg-hover)] rounded-lg">
                      <div className="text-xs text-[var(--text-tertiary)] mb-1">Ahead / Behind</div>
              ...
              <div className="text-center py-16">
                <div className="w-16 h-16 mx-auto mb-4 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-default)] flex items-center justify-center">
                  <svg className="w-8 h-8 text-[var(--text-tertiary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                  </svg>
                </div>
                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2">No repo linked</h3>
                <p className="text-[var(--text-tertiary)]">Connect a repository to see git details</p>
              </div>
            )}
          </div>
        )}
